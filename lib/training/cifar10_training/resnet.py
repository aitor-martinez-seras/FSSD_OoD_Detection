...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out = F.avg_pool2d(out, out.size()[3]) # LO HE AÑADIDO YO PARA QUE FUNCIONE,
        # TIENE QUE VER CON LAS DIMENSIONES DEL TENSOR DE SALIDA, CON EL 4 QUE HABIA PUESTO ANTES NO FUNCIONABA,
...
def ResNet34(num_c=10):
    return ResNet(BasicBlock, [5,5,5], num_classes=num_c)
